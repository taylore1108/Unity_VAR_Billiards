...
public class TwoHand : MonoBehaviour
{
    ...
    public bool backTrigger; // this needs to be whether or not the trigger is pushed 
    public Transform cueTipPosition;
    ...
    {
        backTrigger = backController.activeSelf;
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        Vector3 forceDirection = (collision.contacts[0].point - cueTipPosition.forward).normalized;
        // Vector3 cueForce = Vector3.forward;
        rb.AddForce(forceDirection * cue.velocity.magnitude);
    }
